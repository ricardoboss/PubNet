...
namespace PubNet.API.Migrations
{
    ...
    [Migration("20230130122311_AddPackageVersionAnalysisToPackage")]
    partial class AddPackageVersionAnalysisToPackage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PubNet.Models.PackageVersionAnalysis", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("DocumentationLocalPath")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("PubNet.Models.PackageVersionAnalysis", b =>
                {
                    b.HasOne("PubNet.Models.PackageVersion", "Version")
                        .WithOne("Analysis")
                        .HasForeignKey("PubNet.Models.PackageVersionAnalysis", "VersionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
