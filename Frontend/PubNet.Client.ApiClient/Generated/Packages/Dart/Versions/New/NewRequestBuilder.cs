...
#nullable restore
        ...
        public async Task<global::PubNet.Client.ApiClient.Generated.Models.DartArchiveUploadInformationDto> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::PubNet.Client.ApiClient.Generated.Models.DartArchiveUploadInformationDto>(requestInfo, global::PubNet.Client.ApiClient.Generated.Models.DartArchiveUploadInformationDto.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
