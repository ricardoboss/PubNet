...
#nullable restore
        ...
        public async Task<global::PubNet.Client.ApiClient.Generated.Models.DartPackageListDto> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::PubNet.Client.ApiClient.Generated.Models.DartPackageListDto>(requestInfo, global::PubNet.Client.ApiClient.Generated.Models.DartPackageListDto.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
