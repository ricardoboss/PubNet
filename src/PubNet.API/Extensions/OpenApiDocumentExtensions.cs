...
{
	public static void EnsureAdded<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicProperties)] T>(
		...
		[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicProperties)] Type type)
	{
		...
		return new()
		{
			...
			Properties = type.GetProperties().ToDictionary<PropertyInfo, string, IOpenApiSchema>(
