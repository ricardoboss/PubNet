        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DartPackageId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PackageVersions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PackageVersions_Packages_DartPackageId",
                        column: x => x.DartPackageId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PackageVersions_DartPackageId",
                table: "PackageVersions",
                column: "DartPackageId");
