...
namespace PubNet.Client.Generated.Authentication.RegistrationsOpen {
    ...
    /// </summary>
    public class RegistrationsOpenRequestBuilder : BaseRequestBuilder 
    {
        /// <summary>
        /// Instantiates a new <see cref="RegistrationsOpenRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="RegistrationsOpenRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public RegistrationsOpenRequestBuilder WithUrl(string rawUrl)
        {
            return new RegistrationsOpenRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
