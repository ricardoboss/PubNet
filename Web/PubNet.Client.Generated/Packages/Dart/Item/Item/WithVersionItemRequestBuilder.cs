// <auto-generated/>
using ApiSdk.Packages.Dart.Item.Item.AnalysisJson;
using ApiSdk.Packages.Dart.Item.Item.ArchiveTarGz;
using ApiSdk.Packages.Dart.Item.Item.Docs;
using ApiSdk.Packages.Dart.Item.Item.Retract;
...
using System;
namespace ApiSdk.Packages.Dart.Item.Item {
    /// <summary>
    ...
    public class WithVersionItemRequestBuilder : BaseRequestBuilder {
        ...
        public AnalysisJsonRequestBuilder AnalysisJson { get =>
            new AnalysisJsonRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The archiveTarGz property</summary>
        public ArchiveTarGzRequestBuilder ArchiveTarGz { get =>
            new ArchiveTarGzRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The Docs property</summary>
        public DocsRequestBuilder Docs { get =>
            new DocsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The Retract property</summary>
        public RetractRequestBuilder Retract { get =>
            new RetractRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
